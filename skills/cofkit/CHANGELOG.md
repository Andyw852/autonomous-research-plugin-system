...
- removed machine-specific absolute paths from the user documentation
...
- an internal Zeo++ capability map in [docs/zeopp-capability-map.md](docs/zeopp-capability-map.md)
...
- Wrapper scripts under `examples/`, CLI regression tests, and user docs now point to the grouped command surface.
